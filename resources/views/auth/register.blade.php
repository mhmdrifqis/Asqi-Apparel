    ...
    <div class="flex min-h-screen bg-surface">
        ...
        <div class="hidden lg:flex lg:w-1/2 relative bg-primary items-center justify-center overflow-hidden">
            ...
            <div class="relative z-10 p-12 text-center text-white max-w-xl mx-auto">
                ...
                <h1 class="text-4xl lg:text-5xl font-black uppercase tracking-tight mb-6 leading-tight">
                    Join The <br><span class="text-transparent bg-clip-text bg-gradient-to-r from-accent to-accent-light">Elite</span>
                </h1>
                
                <p class="text-lg text-gray-300 font-medium">
                    Create your account to unlock exclusive drops, fast checkout, and personalized performance recommendations.
                </p>
            </div>
        </div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 lg:p-24 relative overflow-hidden">
            ...
            <div class="absolute inset-0 z-0 lg:hidden opacity-10">
                <img src="https://images.unsplash.com/photo-1571731956672-f2b94e7ddbcd?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80" 
            ...
            <div class="w-full max-w-md relative z-10">
                ...
                <div class="mb-10 text-center lg:text-left">
                    <h2 class="text-3xl font-black uppercase tracking-tight text-primary mb-2">Create Account</h2>
                    <p class="text-text-secondary font-medium">Join us and elevate your performance journey.</p>
                </div>
                ...
                <div class="mt-10 pt-8 border-t border-border text-center">
                    <p class="text-text-secondary font-medium">
                        ...
                        <a href="{{ route('login') }}" class="text-primary font-black uppercase tracking-wider hover:text-accent transition-colors ml-1">Log In</a>
                    </p>
                </div>
            </div>
        </div>
